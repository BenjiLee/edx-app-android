...
public class UserAPI {
    ...
    public LastAccessedSubsectionResponse getLastAccessedSubsection(@NonNull String username, @NonNull String courseId) throws RetroHttpException {
        return userService.getLastAccessedSubsection(username, courseId);
    }

    // TODO 415 UNSUPPORTED MEDIA TYPE
    public LastAccessedSubsectionResponse syncLastAccessedSubsection(@NonNull String username, @NonNull String courseId, @NonNull String lastVisitedModuleId) throws RetroHttpException {
        ...
        return userService.syncLastAccessedSubsection(username, courseId, body, null);
    }
}
